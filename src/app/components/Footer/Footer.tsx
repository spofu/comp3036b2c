    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-columns">
          ...
          <div className="footer-column">
            <h3 className="column-title-small">Support</h3>
            <ul className="footer-links">
          ...
          {/* Column 4: Contact */}
          <div className="footer-column">
            <h3 className="column-title-small">Contact</h3>
            <div className="contact-info">
              <p className="contact-item">
                ...
                <span className="contact-text">123 Fashion Street, London, UK</span>
              </p>
              <p className="contact-item">
                <svg className="contact-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="contact-text">+44 1234 567890</span>
              </p>
              <p className="contact-item">
                <svg className="contact-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="contact-text">support@ecommercetype.com</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="payment-section">
          <div className="payment-methods">
            ...
            <div className="payment-card">
              <span className="payment-text">Apple</span>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p className="copyright">
            &copy; {new Date().getFullYear()} E-Commerce Type Shii. All rights reserved.
          </p>
          <div className="bottom-links">
            ...
            <Link href="/returns" className="bottom-link">Returns Policy</Link>
          </div>
        </div>
      </div>
    </footer>
