...
Call log:
  - waiting for locator('[data-testid="search-input"]')
    ...
    at C:\Users\henry\OneDrive\Documents\uni\ICT-S4\COMP3036\Major\comp3036b2c\tests\e2e\products\optimized-products.spec.ts:241:23
```
...
- banner:
  - navigation:
    ...
    - link "Login":
      - /url: /login
- main:
  - heading "Results for \"test\"" [level=1]
  - paragraph: Searching...
- contentinfo:
  - contentinfo:
